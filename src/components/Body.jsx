  ...
  return (
    <div className="space-y-4 lg:flex">
      ...
      <div className="lg:flex-1 lg:order-1">
        ...
        <p className="font-leto text-gray-400">With Hoster , get your website up and running in no less then 5 minutes with the most competitive pricing packages</p>
        <form action="" className="flex flex-col gap-4 md:flex-row">
          <input className="rounded-md px-4 py-3 placeholder:text-gray-400" type="email" placeholder="Enter Email address" />
          <button className="rounded-md py-3 px-4 bg-blue-400 hover:bg-blue-600 text-white">Join Waitlist</button>

        </form>
        <div className="flex gap-2">
          <img src="./assets/Checkmark.svg" alt="" />
          <p className="font-leto text-gray-400">No spam , even , Unsubscribe anytime</p>
        </div>
      </div>
    </div>
  )
